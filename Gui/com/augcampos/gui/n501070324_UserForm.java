 ...
 */
public class n501070324_UserForm extends javax.swing.JInternalFrame {
     ...
     * @param ps
     */
    public n501070324_UserForm(n501070324_Pessoas ps) {
        this.pesoasLnk = ps;
        initComponents();
        ...
        pnDetailsLayout.setHorizontalGroup(
            ...
            .addGroup(pnDetailsLayout.createSequentialGroup()
                ...
                .addGroup(pnDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtNome, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 306, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void saveData() {
        ...
        n501070324_Utilizador user;
        if (lblNumero.getText().equalsIgnoreCase("<Novo>")) {
            user = new n501070324_Utilizador();
    ...
    private void refreshDetails(n501070324_Utilizador user) {
        if (user != null) {
            lblNumero.setText("" + user.getNumero());
            txtNome.setText(user.getNome());
        }
    }

    private n501070324_Utilizador getSelect() {
